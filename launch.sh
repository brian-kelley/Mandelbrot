#!/bin/bash
build/Mandelbrot -n 4 --size 640x480 --depth -300 --verbose --start 60 --color sunset --position -0.749999987350877481864108888020013802837969258 0.0010000386882368320131245812300498491327594258
